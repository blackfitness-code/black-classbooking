  ...
  wellness: [
    {
      value: 'Sound bath',
      label: 'Sound bath',
      description: 'การบำบัดหรือการผ่อนคลายด้วย “เสียงและการสั่นสะเทือนของคลื่นเสียง” 🎶 โดยผู้เข้าร่วมจะนอนหรือนั่งพักผ่อน แล้วให้เสียงจากเครื่องดนตรีพิเศษโอบล้อมตัว เหมือนอาบน้ำด้วยเสียง จึงเรียกว่า SOUND BATH (อาบเสียง) เหมาะสำหรับ ผู้ที่มีปัญหาด้านการนอน นอนไม่หลับ , ผู้ที่มีความเครียดสะสม , ผู้ที่สนใจการทำสมาธิ , ผู้ที่สนใจการทำคลื่นเสียงบำบัด'
    }
  ]
}
